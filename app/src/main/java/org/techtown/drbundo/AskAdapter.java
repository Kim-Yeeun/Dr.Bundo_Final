...
public class AskAdapter extends RecyclerView.Adapter<AskAdapter.AskViewHolder> {
    ...
    public class AskViewHolder extends RecyclerView.ViewHolder implements View.OnCreateContextMenuListener {
                    ...
                    case 1:
                        ...
                        completebutton.setOnClickListener(new View.OnClickListener() {
                            public void onClick(View v) {
                                ...
                                list.set(getAdapterPosition(), ai);
    ...
    public AskAdapter(Context context, ArrayList<AskItem> arrayList) {
        this.list = arrayList;
        this.context = context;
    }

    @Override
    public AskViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {

        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.question_item_list, viewGroup, false);

        AskViewHolder viewHolder = new AskViewHolder(view);

        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull AskViewHolder viewholder, int position) {

        viewholder.question.setTextSize(TypedValue.COMPLEX_UNIT_SP, 15);
        viewholder.answer.setTextSize(TypedValue.COMPLEX_UNIT_SP, 15);
